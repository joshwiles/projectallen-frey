      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
        ...
        <div class="lg:col-span-1">
          ...
          <div class="flex gap-3">
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 border border-white/15 flex items-center justify-center hover:border-af-accent hover:bg-af-accent/10 transition-all duration-300" aria-label="Follow us on Facebook">
            ...
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 border border-white/15 flex items-center justify-center hover:border-af-accent hover:bg-af-accent/10 transition-all duration-300" aria-label="Follow us on Instagram">
