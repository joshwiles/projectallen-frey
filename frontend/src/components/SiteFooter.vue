  ...
  <footer class="bg-af-dark text-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
        ...
        <div class="lg:col-span-1">
          ...
          <div class="flex gap-3">
            ...
            <a href="https://www.instagram.com/allen_freybuilders" target="_blank" rel="noopener noreferrer" class="w-10 h-10 border border-white/15 flex items-center justify-center hover:border-af-accent hover:bg-af-accent/10 transition-all duration-300" aria-label="Follow us on Instagram">
        ...
        <!-- Company -->
        <div>
          <h3 class="text-sm font-semibold uppercase tracking-widest-plus mb-6 text-white/80">Company</h3>
          <ul class="space-y-3">
            <li><router-link to="/about-us" class="text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">About Us</router-link></li>
            <li><router-link to="/services" class="text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">Services</router-link></li>
            <li><router-link to="/gallery" class="text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">Portfolio</router-link></li>
            <li><router-link to="/contact-us" class="text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">Contact Us</router-link></li>
            <li><router-link to="/get-started" class="text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">Get Started</router-link></li>
            <li><router-link to="/privacy-policy" class="text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">Privacy Policy</router-link></li>
            <li><router-link to="/terms-and-conditions" class="text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">Terms &amp; Conditions</router-link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-4">
            ...
            <li>
              <a href="mailto:info@allen-freybuilders.com" class="flex items-center gap-3 text-white/50 hover:text-af-accent transition-colors duration-300 text-sm">
                <svg class="w-4 h-4 text-af-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                info@allen-freybuilders.com
              </a>
            </li>
            <li class="flex items-start gap-3 text-white/50 text-sm">
              <svg class="w-4 h-4 text-af-accent flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
    ...
    <div class="border-t border-white/10">
      <div class="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-white/40 text-sm">&copy; {{ new Date().getFullYear() }} Allen & Frey Builders and Remodelers. All rights reserved.</p>
        <div class="flex items-center gap-6">
          <a href="tel:5138716679" class="text-white/40 hover:text-af-accent transition-colors duration-300 text-sm">(513) 871-6679</a>
        </div>
      </div>
    </div>
  </footer>
